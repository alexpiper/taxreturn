...
**This package is still in development and many functions are likely to change**
...
The main vignette demonstrates example usage of all main functions. This can be accessed using the following code, or a rendered version can be accessed [here](https://alexpiper.github.io/taxreturn/vignettes/taxreturn-vignette.html)
```{r}

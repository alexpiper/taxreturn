...
fetchSeqs("Scaptodrosophila", database="genbank", out.dir="genbank", downstream=FALSE, marker="COI[GENE] OR COX1[GENE] OR COXI[GENE]", output = "gb-binom", compress=TRUE, force=TRUE, multithread =TRUE)

## OR fetch sequences from a species list
spp_list <- readLines("species_list.txt")
fetchSeqs(spp_list, database="genbank", out.dir="genbank", quiet=FALSE, output = "gb-binom", marker="COI[GENE] OR COX1[GENE] OR COXI[GENE]", compress=TRUE, force=TRUE, multithread = TRUE)
```
...
fetchSeqs("Scaptodrosophila", database="bold", out.dir="bold", downstream=FALSE, marker="COI-5P", output = "gb-binom", compress=TRUE, force=TRUE, multithread = TRUE)

## OR fetch sequences from a species list
spp_list <- readLines("species_list.txt")
fetchSeqs(spp_list, database="bold", out.dir="bold", marker="COI-5P", output = "gb-binom", compress=TRUE, force=TRUE, multithread = TRUE)
```
...
fetchSeqs("Drosophila", database="genbank", out.dir="genbank", quiet=FALSE, marker="mitochondria", output = "gb-binom", force=TRUE, compress=TRUE, multithread = TRUE)

## OR fetch sequences from a species list
spp_list <- readLines("species_list.txt")
fetchSeqs(spp_list, database="genbank", out.dir="genbank", quiet=FALSE, marker="mitochondria", output = "gb-binom", force=TRUE, compress=TRUE, multithread = TRUE)
```
...
## Optional: Blast against wolbachia genome

```{r wolbachia}
fetchSeqs("wolbachia pipientis", database="genbank", out.dir="wolbachia", quiet=FALSE, marker="genome", output = "gb-binom", compress=TRUE)

...
fetchSeqs("Scaptodrosophila", database="genbank", dir="genbank", downstream="species", quiet=FALSE, marker="COI OR COI OR COX1 OR COXI", output = "gb-binom", compress=TRUE, cores=1)
```
...
fetchSeqs("Scaptodrosophila", database="bold", dir="bold", downstream="species", quiet=FALSE, marker="COI-5P", output = "gb-binom",compress=TRUE, cores=1)
...
fetchSeqs("Drosophila", database="genbank", dir="genbank", quiet=FALSE, marker="mitochondria", output = "gb-binom", compress=TRUE, cores=1)
```

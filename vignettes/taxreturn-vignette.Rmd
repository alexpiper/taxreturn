...
fetchSeqs("Scaptodrosophila", database="genbank", out.dir="genbank", downstream=FALSE, marker="COI OR COI OR COX1 OR COXI", output = "gb-binom", compress=TRUE, force=TRUE, multithread = 3)

...
fetchSeqs("Scaptodrosophila", database="genbank", out.dir="genbank", downstream=FALSE, marker="COI OR COI OR COX1 OR COXI", quiet=FALSE, output = "gb-binom", compress=TRUE)
...
fetchSeqs("Scaptodrosophila", database="bold", out.dir="bold", downstream=FALSE, quiet=FALSE, marker="COI-5P", output = "gb-binom", compress=TRUE)
...
# Gett accession numbers to remove

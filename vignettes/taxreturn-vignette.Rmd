...
fetchSeqs("Scaptodrosophila", database="genbank", out.dir="genbank", downstream=FALSE, marker="COI OR COI OR COX1 OR COXI", output = "gb-binom", compress=TRUE, force=TRUE, multithread = TRUE)

## OR fetch sequences from a species list
spp_list <- readLines("species_list.txt")
fetchSeqs(spp_list, database="genbank", out.dir="genbank", quiet=FALSE, output = "gb-binom", marker="COI OR COI OR COX1 OR COXI", compress=TRUE, force=TRUE, multithread = TRUE)
```

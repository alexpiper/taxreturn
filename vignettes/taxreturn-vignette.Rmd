...
fetchSeqs("Scaptodrosophila", database="genbank", out.dir="genbank", downstream=FALSE, marker="COI OR COI OR COX1 OR COXI", quiet=FALSE, output = "gb-binom", compress=TRUE, force=TRUE)

## OR fetch sequences from a species list
spp_list <- readLines("species_list.txt")
fetchSeqs(spp_list, database="genbank", out.dir="genbank", quiet=FALSE, output = "gb-binom", marker="COI OR COI OR COX1 OR COXI", compress=TRUE, force=TRUE)
```
...
fetchSeqs("Scaptodrosophila", database="bold", out.dir="bold", downstream=FALSE, quiet=FALSE, marker="COI-5P", output = "gb-binom", compress=TRUE, force=TRUE)

## OR fetch sequences from a species list
spp_list <- readLines("species_list.txt")
fetchSeqs(spp_list, database="bold", out.dir="bold", quiet=FALSE, marker="COI-5P", output = "gb-binom", compress=TRUE, force=TRUE)
```
...
## OR fetch sequences from a species list
spp_list <- readLines("species_list.txt")
fetchSeqs(spp_list, database="genbank", out.dir="genbank", quiet=FALSE, marker="mitochondria", output = "gb-binom", compress=TRUE)
```

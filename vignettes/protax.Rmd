...
#get taxonomy tree
library(tidyverse)
ranked_lineage <- get_ranked_lineage(db="NCBI", synonyms=FALSE)
...
tax2 <- ranked_lineage %>%
  ...
  mutate(taxname = taxname %>% str_replace(pattern="tax_name=", replacement = "")) %>%
...
protax_get_reference_sequences(install ="protax",
                               taxonomy = "/protax/data/example_taxonomy.txt",
                               trainseq2taxid =  "/protax/data/example_trainseqid2taxname.txt",
                               method = "random", 
                               levels = 2,
                               max_per_level = 10,
                               output = "/protax/data/my_rseqs.txt",
                               seed = 1)
```
...
protax_generate_training_data(install ="protax",
                              ...
                              samples = 100,
                              output = "/protax/data/my_trainsamples.txt",
                              seed=1)
```
